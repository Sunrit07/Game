...
BLACK_KING   = pygame.image.load('images/black_pawn.png')
BLACK_QUEEN  = pygame.image.load('images/black_pawn.png')
BLACK_ROOK   = pygame.image.load('images/black_pawn.png')
BLACK_BISHOP = pygame.image.load('images/black_pawn.png')
BLACK_KNIGHT = pygame.image.load('images/black_pawn.png')
BLACK_PAWN   = pygame.image.load('images/black_pawn.png')
BLACK_JOKER  = pygame.image.load('images/black_pawn.png')

WHITE_KING   = pygame.image.load('images/white_pawn.png')
WHITE_QUEEN  = pygame.image.load('images/white_pawn.png')
WHITE_ROOK   = pygame.image.load('images/white_pawn.png')
WHITE_BISHOP = pygame.image.load('images/white_pawn.png')
WHITE_KNIGHT = pygame.image.load('images/white_pawn.png')
WHITE_PAWN   = pygame.image.load('images/white_pawn.png')
WHITE_JOKER  = pygame.image.load('images/white_pawn.png')
